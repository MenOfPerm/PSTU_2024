...
void main()
{
	...
	//создали вектор из 5 элементов, заполненный нул€ми 
	...
	cout << a << "\n";//вывели значени€ элементов вектора 
	MMany b(10);//создали вектор b из 10 элементов, заполненный нул€ми 
	cout << b << "\n";//вывели значени€ элементов вектора 
	b = a;//присвоили вектору b значени€ вектора a 
	cout << b << "\n";//вывели значени€ элементов вектора 
	MMany c(10); //создали вектор c из 10 элементов, заполненный нул€ми 
	...
	cout << *i << endl; //выводим значени€ элеменов вектора с помощью итератора 
